...
export const TableRowComponent = memo(function TableRowComponent({ token }: TableRowComponentProps) {
  return (
    <TableRow className="border-b border-[#2a2a2a] hover:bg-[#0f0f0f] transition-all duration-200 h-[88px] group cursor-pointer">
      {/* Column 1: Pair Info - 300px */}
      <TableCell className="py-2 pl-4 group-hover:bg-[#1a1a1a] transition-colors" style={{ width: "300px", minWidth: "300px", maxWidth: "300px" }}>
        <TokenInfo token={token} />
      </TableCell>

      {/* Column 2: Market Cap - 140px */}
      <TableCell className="py-2 pr-4 text-right group-hover:bg-[#1a1a1a] transition-colors" style={{ width: "140px", minWidth: "140px", maxWidth: "140px" }}>
        <MarketCapCell marketCap={token.marketCap} change={token.priceChange24h} />
      </TableCell>

      {/* Column 3: Liquidity - 140px - Hidden on mobile */}
      <TableCell
        className="py-2 pr-4 text-right hidden sm:table-cell group-hover:bg-[#1a1a1a] transition-colors"
        style={{ width: "140px", minWidth: "140px", maxWidth: "140px" }}
      >
        <div className="font-mono text-sm text-white group-hover:text-gray-200 transition-colors">${formatNumber(token.liquidity)}</div>
      </TableCell>
      ...
      <TableCell
        className="py-2 pr-4 text-right hidden lg:table-cell group-hover:bg-[#1a1a1a] transition-colors"
        style={{ width: "140px", minWidth: "140px", maxWidth: "140px" }}
      >
        <TransactionCell
      ...
      <TableCell
        className="py-2 text-center hidden lg:table-cell group-hover:bg-[#1a1a1a] transition-colors"
        style={{ width: "140px", minWidth: "140px", maxWidth: "140px" }}
      >
      ...
      <TableCell className="py-2 px-4 text-center group-hover:bg-[#1a1a1a] transition-colors" style={{ width: "120px", minWidth: "120px", maxWidth: "120px" }}>
